...
print('Список ключей: {}'.format(list(data.keys())))
print('Список значений: {}'.format(list(data.values())))
...
del_value = data['tokens'][0].pop('total_out') + data['tokens'][1].pop('total_out')
data['ETH']['total_out'] += del_value

#Внутри "sec_token_info" изменить название ключа “price” на “total_price”.
data['tokens'][1]['total_price'] = data['tokens'][1]["sec_token_info"].pop('price')
